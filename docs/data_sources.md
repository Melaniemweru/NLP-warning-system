# Data sources for NLP RegTech (Kenya)
...
4. **FATF** — general AML recommendations & guidance — **HTML/PDF** — expected ~10 files

> Note: If partner data access is approved (e.g., Absa CDO), add a section with internal sources and permissions required.
